...
public class TriviaQuestionBuilder {
    ...
    public TriviaQuestion build() {
        if((id<0) || "".equals(this.question) || this.question.trim().isEmpty()
            ...
            throw new IllegalStateException("Trivia Question builder is not in buildable state");
        }
        return new TriviaQuestion(id, question, answerA, answerB, answerC, answerD, correctAnswer, hint, lastUpdated);
    }
}